...
def extract_top_words(df):
    ...
    exclusion_words = [
        ...
        'ips','spl','ffa','parietal cortex','fronto parietal','parietal lobes','inferior superior','lobule','lobules',
        'parietal cortices','prefrontal parietal','wm','memory wm','wm task','visuo spatial'
    ]
    ...
    filtered_index_list = list(final_words_vals.keys())
    filtered_vals = list(final_words_vals.values())
...
plt.tight_layout()
# plt.savefig('./test_fig/BrainmapDecoder_topwords_filteredv3.png',dpi=1200)
# plt.savefig('./test_fig/BrainmapDecoder_topwords_filteredv3.svg',dpi=1200)
plt.show()
...
# Adjust layout and save the figure
plt.tight_layout()
# plt.savefig('./test_fig/BrainmapDecoder_regioncloudv3.png',dpi=1200)
# plt.savefig('./test_fig/BrainmapDecoder_regioncloudv3.svg',dpi=1200)
plt.show()
...
# Adjust layout and save the figure
plt.tight_layout()
# plt.savefig('./test_fig/BrainmapDecoder_topwords_expansionv3.png', dpi=1200)
plt.show()
...
# plt.savefig('./test_fig/BrainmapDecoder_expansioncloud_norm.png',dpi=1200)
# plt.savefig('./test_fig/BrainmapDecoder_expansioncloud_norm.svg',dpi=1200)
plt.show()
